...
QUESTION_SET_FILE_PATH          = r'datasets\parsing\data\constituency_annotated_questions_yoyster.json'
...
NCRFPP_DECODE_CONFIG_FILE_PATH  = r'services\parser\static_files\crf-bilstm-decode.config'
